...
PYTEST_CLOUD_REGION, PYTEST_CLOUD_NAME: cloud name and region to use for juju model creation

PYTEST_KEEP_MODEL: if set, the testing model won't be torn down at the end of the testing session
